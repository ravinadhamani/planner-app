...
const EditTaskPopup = ({modal, toggle, updateTask, taskObj}) => {
    ...
    return (
        <Modal isOpen={modal} toggle={toggle}>
            ...
            <ModalFooter>
            <Button color="primary" onClick={handleUpdate} className="allNotesHeadings">Update</Button>{' '}
            <Button color="secondary" onClick={toggle} className="allNotesHeadings">Cancel</Button>
            </ModalFooter>
      </Modal>
    );
};
